...
\DeclareSourcemap{
  \maps[datatype=bibtex]{
    ...
    % A DOI-exported @misc record may repeat the same resolver address in
    % `howpublished`, `url`, and `doi`. Keep the canonical DOI, discard the
    % redundant presentation fields, and map its publisher to the field the
    % standard biblatex @misc driver uses for the artifact's venue.
    \map{
