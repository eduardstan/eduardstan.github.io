...
\DeclareSourcemap{
  \maps[datatype=bibtex]{
    ...
    % Prefer structured link fields for every entry: suppress howpublished
    % whenever a URL or DOI is present, then suppress URL whenever a DOI is
    % present. For @misc records, map publisher to the field the standard
    % biblatex driver uses for the artifact's venue.
    \map{
